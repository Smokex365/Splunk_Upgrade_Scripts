...
if [ ! -f 'splunku.sh' ]
    then
    wget -q --secure-protocol='auto' -O 'splunku.sh' 'https://www.dropbox.com/sh/yjw4uewbrmotrpc/l0bAMs3DiO/splunku.sh?dl=1'
    chmod u+x splunku.sh
else
    wget -q --secure-protocol='auto' -O 'splunku.sh.tmp' 'https://www.dropbox.com/sh/yjw4uewbrmotrpc/l0bAMs3DiO/splunku.sh?dl=1'
